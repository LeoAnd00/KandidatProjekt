...
# k_acc_pro => 0.0, k_acc_glu => 0.05, k_degr => 0.09, k_acc_nh4 => 0.0, NH4 => 0.0, Proline => 0.0, # Glutamine
...
# w_pka => 0.06, w_pka_sch9 => 17.5, PKA_T => 1.0, w_pka_camp => 102.11, sigma_pka => 1.0, gammapka => 2.68, # PKA
# k_pr => 0.02, # Protein
...
# w_tps_pka => 0.57, sigma_tps => 5.0, gammatps => 0.47, w_tps => 0.05, Tps1_T => 1.0, # Tps1
...
# "k_acc_pro", "k_acc_glu", "k_degr", "k_acc_nh4", "NH4", "Proline", # Glutamine
...
# "w_tps_pka", "sigma_tps", "gammatps", "w_tps", "Tps1_T", # Tps1
