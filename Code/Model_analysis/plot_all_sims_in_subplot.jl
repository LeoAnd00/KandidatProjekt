...
p11=return_simulation_result(sol_array_nit_starve, Dot6, (0.0, 40.0), (0.0, 1.1), "Kvävesvältning",:bottomright) 
...
p14=return_wt_mut_results(sol_array_nit_add, sol_array_gtr1Delta, Gln3, (0.0, 25.0), (0.0, 1.0), "Kvävetillsättning, gtr1\$\\Delta\$", :right)

###### Snf1 deletion, Glucose starvation ######
sol_array_Snf1Delta = Generate_sol_array(index_glucose_starvation, (0.0, 1.0), [Snf1_T => 0.0])

p15=return_wt_mut_results(sol_array_gluc_starve, sol_array_Snf1Delta, Gln3, (0.0, 0.5), (0.0, 0.4), "Glukossvältning, Snf1\$\\Delta\$", :right)
p16=return_wt_mut_results(sol_array_gluc_starve, sol_array_Snf1Delta, Cyr1, (0.0, 0.5), (0.0, 0.8), "Glukossvältning, Snf1\$\\Delta\$", :right)
