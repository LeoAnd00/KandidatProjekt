...
function Glucose_starvation_Snf1()
    ...
    plot1 = scatter(t_Snf1, data_Snf1, markersize = 5.5, markercolor="blue", markerstrokewidth=0.8, label = "Data")
...
function Glucose_starvation_Sch9()
    ...
    plot2 = scatter(t_Sch9_glucose_starve, data_Sch9_glucose_starve, markersize = 5.5, markercolor="blue", markerstrokewidth=0.8, label = "Data")
