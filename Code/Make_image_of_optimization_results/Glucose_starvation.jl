...
function Glucose_starvation_Snf1()
    ...
    plot1 = scatter(t_Snf1, data_Snf1, markersize = 5.5, color = color_data, markerstrokewidth=0.8, label = "Data")

    plot!(plot1, sol_Snf1, vars=Snf1, color = Color_alt_1, lw=2.5, labels= label_alt_1)
...
function Glucose_starvation_Sch9()
    ...
    plot2 = scatter(t_Sch9_glucose_starve, data_Sch9_glucose_starve, markersize = 5.5, color = color_data, markerstrokewidth=0.8, label = "Data")

    plot!(plot2, sol_sch9, vars=Sch9, color = Color_alt_1, lw=2.5, labels= label_alt_1)
