...
@parameters gammacyr, Cyr1_T, w_cyr_glu, w_cyr_snf, sigma_cyr, w_cyr, w_dot, sigma_dot, w_dot_sch_pka, Dot6_T, 
w_ego, sigma_ego, w_ego_basal, EGO_T, gammaego, w_ego_gap, gammagap, sigma_gap, w_gap_torc, w_gap_N, EGOGAP_T, 
...
Snf1_T, w_torc_egoin, w_torc, w_torc_snf, w_torc_glut, sigma_tor, gammator, TORC1_T, w_torc_ego, w_tps_pka, sigma_tps,
...
@variables t, Cyr1(t), Dot6(t), EGO(t), EGOGAP(t), Gcn2(t), Gcn4(t), Gis1(t), Gln1(t), Gln3(t), Glutamine(t), 
...
eqs = [
    ...
    D(EGO) ~ gammaego*(EGO_T*soft_Heaviside(sigma_ego,w_ego_gap*EGOGAP*(Glutamine_ext+0.5*NH4+0.01*Proline)
    -w_ego*(1-Glutamine)-w_ego_basal)-EGO),
    ...
    # Master regulators
    D(TORC1) ~ gammator*(TORC1_T*soft_Heaviside(sigma_tor,w_torc_glut*Glutamine+w_torc_ego*EGO-w_torc_egoin*
    (1-EGO)-w_torc-w_torc_snf*Snf1)-TORC1),
